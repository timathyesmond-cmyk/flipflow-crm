  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8">
      ...
      <div className="space-y-5">
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-widest text-blue-600 mb-3 border-b border-blue-200 pb-1">Subject-To Mortgage</p>
      ...
      <div className="space-y-3">
        ...
        <div ref={reportRef} className="bg-[#f5f0e8] rounded-2xl p-6 space-y-4 font-mono">
          ...
          <div className="text-center mb-4">
            <h2 className="text-4xl font-black tracking-tight text-gray-900">SUBJECT-TO</h2>
